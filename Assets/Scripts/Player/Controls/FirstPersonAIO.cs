    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Movement Setup
            ...
            if(showAdvanced){
                ...
                EditorGUILayout.Space();
                t.advanced.FOVKickAmount = EditorGUILayout.Slider(new GUIContent("FOV Kick Amount","Determines how much the camera's FOV will kick upon entering a ."),t.advanced.FOVKickAmount,0,5);
